defmodule Reencodarr.Validation do
  @moduledoc """
  ...
  """
  def validate_number_range(changeset, field, min_val, max_val, message \\ nil) do
    value = get_field(changeset, field)
  ...
  @doc """
  Validates video resolution fields (width and height).
  """
  def validate_video_resolution(changeset) do
  ...
  @doc """
  Validates consistency between format and other track fields.
  """
