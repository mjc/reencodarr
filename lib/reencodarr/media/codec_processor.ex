defmodule Reencodarr.Media.CodecProcessor do
  @moduledoc """
  Centralizes codec processing logic including normalization, commercial name mapping,
  and codec list operations.

  Extracts codec-related functionality that was scattered across multiple modules.
  """
  ...
  Assumes the first codec in the list is the primary video codec.
  """
  ...
  Looks for HDR-related codec indicators.
  """
