...
config :reencodarr,
  ...
  crf_execution_mode: :broadway,
  distributed_worker_enabled: true,
  worker_connect_url: "http://127.0.0.1:4000",
  worker_executable: "ab-av1",
  worker_id: nil,
  worker_extra_args: [],
  worker_restart_base_ms: 1_000,
  worker_restart_max_ms: 30_000,
  worker_chunk_size_bytes: 134_217_728,
